"""SD02反映後の健全性チェック: 実デッキ(decklists/SD02.json)でランダム自己対戦を回す。

再現: python3 scripts/sd02_selfplay_smoke.py
...
DECKLIST_PATH = os.path.join(os.path.dirname(__file__), "..", "decklists", "SD02.json")
